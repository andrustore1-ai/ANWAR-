const CACHE='andro-store-pos-v3';
const ASSETS=['./','./index.html','./products.html','./phones.html','./sales.html','./maintenance.html','./purchases.html','./suppliers.html','./customers.html','./banks.html','./debts.html','./debt-details.html','./reports.html','./settings.html','./login.html','./manifest.json'];
